...
The project includes a heat diffusion simulation that demonstrates how heat spreads from a single point source. The visualization is generated using a 2D heat equation with the following parameters:
...
1. Initial hot point in the center
2. Heat spreading outward in a circular pattern
3. Temperature gradient represented by the 'inferno' colormap
4. Grid lines for better spatial reference

![Heat Diffusion Visualization](Plots/heat_diffusion_visualization.gif)

The visualization can be regenerated by running:
```bash
python processing/diffusion.py
``` 